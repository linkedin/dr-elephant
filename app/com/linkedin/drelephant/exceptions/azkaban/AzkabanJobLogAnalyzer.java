...
public class AzkabanJobLogAnalyzer {
  ...
  public AzkabanJobLogAnalyzer(String rawLog) throws InsufficientLogException {
    this._rawLog = rawLog;
    setSubEvents();
    analyzeLog();
  }
   ...
   */
  private void analyzeLog() throws InsufficientLogException {
    if (_successfulAzkabanJobPattern.matcher(_rawLog).find()) {
      ...
      throw new InsufficientLogException("Couldn't determine the finish status of job using the azkaban logs.");
    }
  }
