...
-- For h2 bases:
ALTER TABLE job_suggested_param_set ALTER COLUMN id int(10) unsigned NOT NULL AUTO_INCREMENT;
...
ALTER TABLE job_suggested_param_set ADD UNIQUE KEY job_execution_id_2 (job_execution_id);
...
ALTER TABLE flow_definition DROP COLUMN created_ts;
ALTER TABLE flow_definition DROP COLUMN updated_ts;
ALTER TABLE flow_execution DROP COLUMN created_ts;
ALTER TABLE flow_execution DROP COLUMN updated_ts;
ALTER TABLE tuning_job_execution DROP COLUMN created_ts;
ALTER TABLE tuning_job_execution DROP COLUMN updated_ts;